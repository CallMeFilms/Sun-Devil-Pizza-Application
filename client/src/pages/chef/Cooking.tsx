            ...
            <Card className="col-8 m-auto">
                <Card.Body>
                   <div className="container p-3">
                        {state.cooking.length === 0 && <h4>No Orders</h4>}
                        {state.cooking.map((order: Order) => {
                                ...
                                <Card.Body>
                                    ...
                                    <div className="container d-flex justify-content-between">
                                        ...
                                        <div className="p-2 align-self-end">
                                            <button onClick={() => { incrementStatus(order) }} className="btn btn-outline-success align-self-end">Finish Cooking</button>
                                        </div>
                                    </div>
                                </Card.Body>
                            </div>
